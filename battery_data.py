...
class CycleData:
    def __init__(self,
                 ...
                 *,
                 ...
                 labeled_soh: float = None,
                 labeled_V: List[float] = None,
                 labeled_I: List[float] = None,
                 labeled_t: List[float] = None,
                 labeled_Qc: List[float] = None,
                 **kwargs):
        ...
        self.labeled_soh = labeled_soh
        self.labeled_V = labeled_V
        self.labeled_I = labeled_I
        self.labeled_t = labeled_t
        self.labeled_Qc = labeled_Qc
    ...
    def to_dict(self):
        return {
            ...
            'labeled_soh': self.labeled_soh,
            'labeled_V': self.labeled_V,
            'labeled_I': self.labeled_I,
            'labeled_t': self.labeled_t,
            'labeled_Qc': self.labeled_Qc,
            **self.additional_data
        }
