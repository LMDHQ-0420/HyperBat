...
if __name__ == "__main__":
    ...
    # 模型路径
    model_path = result_dir / 'GMA-NET.pkl'
    hyper_model_path = result_dir / f'HyperLoRA_{args.local_num_cycles}_{args.global_num_cycles}_wsize_{args.window_size}_stride_{args.stride}.pkl'
    
    # 输出详细 CSV 的路径
    detailed_csv_path = result_dir / f'HyperBat_Detailed_Eval_ws{args.window_size}_l{args.local_num_cycles}.csv'
